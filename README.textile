...
user is not intended to checkout this branch. It is used solely for record
...
there, you will not have to look at this data.  I just picked XML because it's
(a) relatively future-proof, and (b) very merge-friendly.

The contained data maps directly on to what you see from the @git issues show@
...
"Tags" field is freely assignable to any value; all other fields should match
